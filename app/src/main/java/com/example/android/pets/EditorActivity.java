...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final String TAG = "EditorActiviyu";
    ...
    private void editPet() {
        ...
        if (mWeightEditText.getText().toString().isEmpty()) {
            weightInt = 0;
            Toast.makeText(this, "Using 0 for weight.", Toast.LENGTH_SHORT).show();
        } else {
            weightInt = Integer.parseInt(mWeightEditText.getText().toString());
        }

        if (currentPetUri == null &&
                TextUtils.isEmpty(nameString) && TextUtils.isEmpty(breedString) &&
                TextUtils.isEmpty(mWeightEditText.getText().toString()) && mGender == PetEntry.GENDER_UNKNOWN) {
            return;
        }
